...
kpis=[('users',len(athletes),'Atletas','kblue','Ver equipe →'),('coach',len(staff),'Técnicos','kgreen','Ver equipe →'),('team',len(visible_teams),'Times','kpurple','Ver times →'),('chart',len(visible_trainings),'Treinos','korange','Ver histórico →')]
